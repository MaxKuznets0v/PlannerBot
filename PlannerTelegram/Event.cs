        ...
        public Event(Event e)
        {
            ...
            if (time != Time.NoTerm)
            {
                ...
                if (time == Time.Today)
                {
                    ...
                    for (int i = 0; i < (int)importance - 1; ++i)
                        notifyTime.Add(new DateTime(DateTime.Now.AddHours(3).Year, DateTime.Now.AddHours(3).Month, DateTime.Now.AddHours(3).Day, 0, 0, 0).AddHours((i + 1) * (24 / (int)importance)));
            }
        }
